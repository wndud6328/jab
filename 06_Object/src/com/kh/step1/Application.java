...
public class Application {
	 ...
	 * 
	 * 객체 지향 프로그래밍의 특징
	 * 1. 추상화 : 객체들이 가진 공통의 특성들을 파악하고
	 *            불필요한 특성들을 제거하는 과정
	 * 2. 캡슐화 : 객체의 속성(필드)와 기능(메소드)을 하나로 묶고
	 *            실제 구현 내용을 감추는 것
	 * 3. 상속 : 하나의 객체가 가지고 있는 속성(필드)과 기능(메소드)를
	 *          다른 객체가 물려받는 것
	 * 4. 다형성 : 같은 타입이지만 실행 결과가 
	 *            다양한 객체를 이용할 수 있는 성질
	 *            
	 * 클래스
	 ...
	 * - 클래스는 필드(Field), 메소드(Method), 
	 *           생성자(Constructor)가 정의
	 * - 클래스 작성 시 객체 지향 언어의 특징 중
	 *   추상화(Abstraction), 캡슐화(Encapsulation)가 
	 *   적용되어야 함          
	 * 
	 * */
	public static void main(String[] args) {
		...
		tv.channelDown();
		tv.channelUp();
		System.out.println("TV 채널 : " + tv.channel); // 22
