...
public class A_Array {
	...
	public void method1() {
		...
		int[] score = new int[5]; // 배열의 크기를 지정하지 않았을 때
		
		/*
		 * 기본 자료형 : 스택 메모리에 생성된 공간에 실제 변수값을 저장하는 방법
		 * 참조 자료형 : 실제 데이터 값은 힙 메모리에 저장하고,
		 * 			  스택 메모리의 변수 공간에는 실제 변수값이 저장된 힙 메모리의 주고값 저장
		 */
		
		
//		System.out.println(score); // [I@626b2d4a
	...
	public void method8(){
		...
		int [] number = {1, 2, 3, 4, 5};
		int[] copy = null;
		//System.out.println(copy.length); // NullPointer
