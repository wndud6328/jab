...
//			System.out.println("박주영" == name); 	// false
//			System.out.println("박주영".equals(name)); // true, String 클래스의 equals() 메소드
//			System.out.println("박주영".charAt(0)); //String 클래스의 charAt(0) 메소드
	 ...
	 * 실행할 코드.. } else { .. 위에 어느 조건식에도 만족하지 않을 때 실행할 코드.. } - else if 수는 제한이 없다. -
	 * else는 생략 가능하다.
	 */
	public void method5() {
	...
	/*
	 * 사용자에게 정수(0~100)을 입력받아서 점수별로 등급을 출력하라 - 90점 이상은 A 등급 - 90점 미만 80점 이상은 B 등급 -
