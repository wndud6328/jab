...
public class Application {
	 ...
	 *   인터페이스에 추상 메서드를 추가해서 객체가 기능을 구현하도록 만듦
	 ...
	 * - 인터페이스 간에 상속 관계일 때 : 인터페이스 명 extends 인터페이스명, 인터페이스명, ...
	 *   
	 * 추상 클래스 : 미완성 설계도
	 * 인터페이스  : 기본 설계도 <- 많이 접하게 될 것임
	 * 
	 */
	public static void main(String[] args) {
		
//		Vehicle v = new Vehicle(); <-- 인터페이스 객체생성 X
		Vehicle bus = new Bus();
