...
//		c.method4();
	...
	public void method1() {
		...
		while(i<=3) {
			...
			} catch (/*ArrayIndexOutOfBounds*/Exception e) { // Exception 이 최상위 클래스여서 다 잡아낼 수 있다.
	...
	public void method3() {
		...
		try {
			...
			System.out.println("에외 발생 여부와 상관없이 무조건 수행");
		} 
	...
	public void method4() {
		...
		} catch (/*NullPointer*/ Exception e) { // Exception 이 다 잡아낼 수 있음.
			System.out.println(e.getMessage());
		}
	}
}
