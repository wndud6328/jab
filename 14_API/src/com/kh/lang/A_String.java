 ...
 * - java.lang 패키지에 있는 클래스와 인터페이스는 import 없이 사용할 수 있따.
 */
...
//		a.method4();
	...
	public void method1() {
		...
		System.out.println("str2 == str3 : " + (str2 == str3)); // true/false
		System.out.println("str3 == str4 : " + (str3 == str4)); // false
		
		System.out.println();
		
		// toStrin() 메서드는 String 클래스에서 오버라이딩
	...
	public void method2() {
		...
		// 1. charAt(int index) : char - 전달받은 index 위치에 하나의 문자만 추출해서 리턴
		...
		// 4. indexOf(String str) : int - 전달받은 str의 시작 인덱스를 리턴
		// 	  indexOf(char ch) 	  : int - 전달받은 ch의 인덱스를 리턴 (주어진 문자가 포함되어있지 않으면 -1 리턴)
	 ...
	 * - 가변의 클래스 : 내부의 무자열을 수정할 수 있음
	 * - 16개의 문자를 저장할 수 있는 버퍼가 미리 생성되고 문자가 저장됨에 따라 자동으로 증가
	 * - StringBuilder와 StringBuffer 차이점 : 동기화가 되느냐 안 되느냐
	...
	public void method3() {
		...
		// StringBuilder 클래스의 생성자에 문자열을 전달해 주면
	...
	public void method4() {
		...
		// IPA avaJ
		sb2.append(" AP").reverse().delete(3,11).insert(0,'I');
		System.out.println(sb2);
	}
	public void method5() {
		// 구분자를 이용하여 문자열 분리
		
		String str = "Java,Oracle,JDBC,HTML,CSS,JavaScript,jQuery,Servelet,JSP,MyBatis,Spring,React";
		
		// 1. String 클래스의 split 메서드를 이용하는 방법
		//   split(String regex) : 입력받은 구분자로 문자열을 분리해서 문자열의 배열로 담아서 리턴
		String[] strArr = str.split(",");
		System.out.println("split : " + strArr.length);
