...
//		a.method3();
	...
	public void method1() {
		...
		// 2023년 6월 13일 화요일 오후 2시 21분 10초
		SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy년 MM월 dd일 (E) a hh시 mm분 ss초");
...
//		Calendar cal = new Calendar(); 추상클래스는 객체 생성 X
	...
	// 자신이 태어난 날을 yyyy/MM/dd 형태로 입력받아 해당 날짜가
	// 무슨 요일이었는지, 지금까지 며칠이 지났는지 계산
	...
	public void practice() {
		   	...
		   	SimpleDateFormat sdf2 = new SimpleDateFormat("yyyy/MM/dd 은 E요일 입니다.");
