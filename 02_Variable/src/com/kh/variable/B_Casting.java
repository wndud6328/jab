...
//		b.autoCasting();
	...
	public void autoCasting() {
		...
		float f = 1;  // 4byte(표현 가능한 수의 범위가 더 크기 때문에 자동 형 변환이 가능)		
		double d = 1; // 8byte
	...
	/*
	   ...
	   - 범위가 큰 크기의 자료형의 데이터를 작은 크기의 자료형으로
	     변환하려고 할 때 사용한다.
	   - 강제 형 변환의 경우 데이터 손실이 발생할 수 있다.
	*/
	public void casting() {
		double d = 4.12345678904567890; // (소수점) 15자리 수
		float f = (float) d; // (소수점) 6자리 수 
