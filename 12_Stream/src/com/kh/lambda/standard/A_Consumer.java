...
/*
 *  표준 함수적 인터페이스
 * - 자바 8 부터 빈번히 사용되는 함수적 인터페이스는 java.util.function
 *   표준 API 패키지로 제공
 * - 자바 8부터 추가되거나 변경된 API는 이 표준함수적 인터페이스들을
 *   매개 타입으로 사용
...
//		a.method3();
	 ...
	 * ObjLongConsumer<T> : T 객체와 long값을 받아 소비
	 * ObjDoubleConsumer<T> : T 객체와 double값을 받아 소비
	 * 
	 */
	public void method4() {
